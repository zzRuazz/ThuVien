...
const PageURL = "/san-pham/thuoc-tinh";
...
$(function () {
    $(".page-link").click(function (e) {
        ...
        window.location.href = `/san-pham/thuoc-tinh/${page}/${limit}`
    })
})
...
async function Create() {
    ...
    const property = { Name, Slug, CategoryId, IsActived, IsDeleted }
...
async function Update(Id) {
    ...
    const property = { Id, Name, Slug, CategoryId, IsActived, IsDeleted }
